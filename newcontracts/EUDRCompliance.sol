...
contract EUDRCompliance is AccessControl {
    ...
    // Mapeo para almacenar el estado más reciente de cumplimiento de cada activo
    mapping(uint256 => bool) private latestComplianceStatus;
    ...
    function verifyCompliance(
        ...
        // Actualizar el estado de cumplimiento más reciente del activo
        latestComplianceStatus[assetId] = isCompliant;
    ...
    function isAssetEUDRCompliant(uint256 assetId) public view returns (bool) {
        return latestComplianceStatus[assetId];
    }
}
